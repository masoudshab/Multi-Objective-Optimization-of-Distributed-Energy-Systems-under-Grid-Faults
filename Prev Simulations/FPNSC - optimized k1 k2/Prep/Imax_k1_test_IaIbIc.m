...
hold on
plot(k1_opt(O),min(Imax_opt),'r*')
% plot(k1_opt(2),sqrt(Ib_opt(2)),'go')
% plot(k1_opt(3),sqrt(Ic_opt(3)),'ko')
                    title(i)
...
i=i+1;
                  ...
                  %%
                    ...
                    if delta_IaIc>=0
                        ...
                        plot(k1_intsec_IaIc,sqrt(Ia_intsec),'bs','MarkerSize',10,'MarkerFaceColor','b')
